...
if not students:
    st.warning("No students available. Please register students first.")
    st.stop()
...
for student in students:
    ...
    student_names.append(full_name.strip())
...
if reports:
    for report in reports:
        st.write(f"{report['student_name']} | BMI: {report['bmi']} | {report['category']}")
else:
